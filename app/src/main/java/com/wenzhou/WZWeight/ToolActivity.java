...
import com.wenzhou.WZWeight.SearchActivity.GetRegionTask;
import com.wenzhou.WZWeight.SearchActivity.YesterdayWeightTask;
...
public class ToolActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		update.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Toast.makeText(ToolActivity.this, "��ǰ�Ѿ������°汾��", Toast.LENGTH_SHORT).show();
			}
		});
